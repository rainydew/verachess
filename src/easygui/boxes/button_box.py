...
class ButtonBox(object):
    ...
    def __init__(self, msg, title, choices, images, default_choice, cancel_choice, callback, fontsize):
        """ Create box object
        ...
        self.ui = GUItk(msg, title, choices, images, default_choice, cancel_choice, self.callback_ui, fontsize)
...
class GUItk(object):
    ...
    def __init__(self, msg, title, choices, images, default_choice, cancel_choice, callback, fontsize):
        ...
        self.create_buttons(choices, default_choice, fontsize)
    ...
    def create_buttons(self, choices, default_choice, fontsize):
        ...
        for row, (button_text, unique_button_text) in enumerate(zip(choices, unique_choices)):
            ...
            if fontsize:
                this_button['widget'].configure(font="-size {}".format(fontsize))
